...
\newglossaryentry{GIY-YIG domain}{
	name={GIY-YIG domain},
	description={one of the two types of endonuclease domains found in homing endonuclease proteins; the other is HNH}
}
\newglossaryentry{HNH domain}{
	name={HNH domain},
	description={an endonuclease domain found in many DNA cutting enzymes and also found encoded in one of the two classes of homing endonuclease genes, the other being GIY-YIG}
}
...
\newglossaryentry{Shine-Dalgarno (SD)}{
	name={Shine-Dalgarno},
...
\newglossaryentry{efficiency of plating (EOP)}{
	name={efficiency of plating (EOP)},
...
\newglossaryentry{homing endonuclease}{
	name={homing endonuclease},
	description={an endonuclease that cuts DNA homologous to the DNA in which the endonuclease gene resides.  Host recombination repair will then fix the double-strand break by homologous recombination, using as the \textquotedbl{}good\textquotedbl{} copy the DNA containing the homing endo gene.  As a result, if two phages infect the same cell and one has a homing endo gene in a certain place, the other phage will have the homing endo inserted in the same place after this breakage and repair event.  Basically, homing endo's simply spread to naive DNA of the same sequence. How they get into a particular context originally is not known.  Homing endo's come in two \textquotedbl{}types\textquotedbl{}:  HNH and GIY-YIG.}
}
...
\newglossaryentry{illegitimate recombination}{
	name={illegitimate recombination},
	description={a very low frequency event where DNA is exchanged without detectable flanking homology and without participation of transposases. This is the moral equivalent for evolutionary biology of \textquotedbl{}idiopathic\textquotedbl{} pathogenesis for clinicians. That is, nobody knows how it occurs but it does.}
}
