...
\newglossaryentry{defective prophage}{
	...
	description={a prophage that has undergone mutations, including deletions, such that a viable virion is no longer encoded. E. coli K-12 has several, including dlp at 12 min, for example.}
}
...
\newglossaryentry{homology-dependent recombination}{
	name={homolog-dependent recombination},
	description={}
}
